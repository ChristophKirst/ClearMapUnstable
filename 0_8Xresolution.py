...
BaseDirectory = '/home/mtllab/Documents/countingaccuracy/resolution';
   
cFosFile = '/home/mtllab/Documents/countingaccuracy/resolution/151012_0_8Xs3_16-09-57.tif';
AutofluoFile = '/home/mtllab/Documents/countingaccuracy/resolution/151012_0_8Xs3_16-09-57.tif';
cFosFileRange = {'x' : all, 'y' : all, 'z' : (118,1237)};#cFosFileRange = {'x' : all, 'y' : (180, 2560), 'z' : all};
...
SpotDetectionParameter["sink"] = (os.path.join(BaseDirectory, 'cells-allpoints-0_8X.npy'),  os.path.join(BaseDirectory,  'intensities-allpoints-0_8X.npy'));
