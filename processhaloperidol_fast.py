...
#lightsheetTransformed = transformData(CorrectionAlignmentParameter["movingImage"], sink =  os.path.join(BaseDirectory, 'affine.tif'), transformDirectory = CorrectionAlignmentParameter["resultDirectory"], resultDirectory = None)
...
points, intensities = thresholdPoints(points, intensities, threshold = (20, 500), row = (3,3));
